// ─── Meditation library ─────────────────────────────────────────────────────
//
// Text-only for now (same scripts double as voice note scripts once TTS is
// wired up). Menu items are bare — no taglines/explanations under each
// purpose, per product direction. A short "new to this?" note is shown once,
// separate from the menu itself, before someone's first session.
//
...
export const MEDITATIONS: Record<string, string[]> = {
  morning: [
`🌅 *Morning Light* (about 2 minutes)

Find a comfortable position, sitting or lying down. Let your eyes close, or soften your gaze downward.

Take a slow breath in through your nose... and let it out slowly through your mouth. One more like that — in... and out.
...
`🌅 *One Step At A Time* (about 2 minutes)

Sit or lie down comfortably. Let your shoulders drop away from your ears.

Breathe in slowly for a count of four... hold gently... and release for a count of four.
...
When you're ready, open your eyes and meet the day, one step at a time.`,
  ...
  stress: [
`😌 *Releasing the Tension* (about 2-3 minutes)

Find a comfortable seated position. Let your hands rest gently in your lap.

Breathe in through your nose for a count of four... and out through your mouth for a count of six, letting the exhale be longer than the inhale.
...
`😌 *Slowing Down* (about 2 minutes)

Sit or lie down somewhere quiet. Let your eyes close if that feels comfortable.

Breathe in slowly... and notice the pause at the top of the breath before you let it go.
...
When you're ready, open your eyes, carrying a little more calm with you.`,
  ...
  overthinking: [
`💭 *Setting the Thoughts Down* (about 2-3 minutes)

Get comfortable, and let your eyes close gently.

Notice the thoughts moving through your mind right now, without trying to stop them.
...
`💭 *Coming Back to Now* (about 2 minutes)
...
When you're ready, open your eyes, a little more anchored in the present.`,
  ...
  sleep: [
`🌙 *Winding Down* (about 2-3 minutes)

Lie down comfortably, and let your body sink into the bed.

Take a slow breath in... and a longer breath out, letting your body get heavier with each exhale.
...
`🌙 *Letting the Day Go* (about 2 minutes)

Get comfortable in your bed, and let your eyes close.

Breathe in slowly... and out, even more slowly.
...
Continue breathing slowly, letting each breath carry you closer to sleep.`,
  ...
  emotional_reset: [
`💗 *Making Space* (about 2-3 minutes)

Sit or lie down comfortably, and let your eyes close.

Notice whatever you're feeling right now, without needing to change it immediately.
...
`💗 *Steadying Again* (about 2 minutes)

Find a comfortable position and let your breath settle.
...
When you're ready, open your eyes, a little calmer than before.`,
  ...
  body_relaxation: [
`🧘 *Releasing Tension* (about 3 minutes)

Lie down or sit comfortably, and close your eyes.

Starting with your feet, gently tense them for a moment... then release, letting them go completely soft.
...
`🧘 *Body Scan* (about 2-3 minutes)

Get comfortable, and let your eyes close.

Bring your attention to the top of your head, and imagine any tension there melting away.
...
When you're ready, open your eyes, carrying this looseness with you.`,
  ...
  period_calm: [
`🌸 *Gentle Rest* (about 2-3 minutes)

Lie down somewhere comfortable, ideally with something warm nearby if that helps.

Take a slow breath in... and let it out fully, allowing your body to soften.
...
`🌸 *Softening Through Discomfort* (about 2-3 minutes)

Get into whatever position feels most comfortable for your body right now — curled up, lying flat, whatever eases things.

Breathe in slowly... and out, a little longer than the inhale.
