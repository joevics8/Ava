  ...
  const commands = await fetch(`${BASE}/setMyCommands`, {
    ...
    body: JSON.stringify({
      commands: [
        ...
        { command: 'docprep', description: 'Summary to take to your doctor' },
        { command: 'weekly', description: 'Your weekly health briefing' },
        { command: 'referral', description: 'Earn \u20a61,000 per friend who upgrades' },
        ...
        { command: 'deletedata', description: 'Permanently delete your data' },
        { command: 'cancel', description: 'Cancel your Premium subscription' },
